...
shared_data.desired_torso_pose = vector.zeros(6)
shared_data.desired_torso_twist = twist.zeros()
shared_data.desired_joint_force = vector.zeros(#Config.joint.id)
shared_data.desired_joint_position = vector.zeros(#Config.joint.id)
shared_data.desired_joint_velocity = vector.zeros(#Config.joint.id)
