...
qLArm={qLArm0[1],qLArm0[2]};
qRArm={qRArm0[1],qRArm0[2]};
...
--  gyro_min = 0.7*180/math.pi;
  gyro_min = 0.2*180/math.pi;
...
-- gyro_pitch=gyro_pitch-gyroTilt; --canceling out body motion
  ...
  if enable_ankle_pr then
    ...
    if hipStrategy == 0 then  
     ankleShiftX
=util.procFunc(gyro_pitch*ankleImuParamX[2],ankleImuParamX[3],ankleImuParamX[4]);
