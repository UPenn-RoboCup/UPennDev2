...
kick.qHipRollCompensation = 0*math.pi/180;
...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {2, 0.2, {-0.02, -0.07,0} , {-0.06,0,0}, 0.08 , 10*math.pi/180}, --Lifting
     {2, 0.1, {-0.02,-0.07,0} , {0.26,0,0},  0.03 , -20*math.pi/180}, --Kicking
     {2, 0.4, {-0.02,-0.07,0} , {0,0,0},  0.05 , 0*math.pi/180}, --Kicking
...
kick.def["kickForwardRight"]={
  ...
  def = {
    ...
    {3, 0.2, {-0.02 ,0.07,0} , {-0.06, 0.0, 0}, 0.08 , 10*math.pi/180},
    {3, 0.1, {-0.02 ,0.07,0} , {0.26, 0, 0},  0.03 , -20*math.pi/180}, --Kicking
    {3, 0.4, {-0.02 ,0.07,0} , {0, 0, 0},  0.05 , 0*math.pi/180}, --Kicking
