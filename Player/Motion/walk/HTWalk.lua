...
function calculate_body_height(ph)
   ...
   footHeight = Config.walk.footHeight;
   legLength = Config.walk.legLength;
   hipOffsetX = Config.walk.hipOffsetX;
   hipOffsetY = Config.walk.hipOffsetY;
   hipOffsetZ = Config.walk.hipOffsetZ;
...
--  extendedLeg = 1-extendedLeg;
--   extendLeg = supportLeg;

   legHeight = 0;
   if extendedLeg==0 then
     legHeight = math.sqrt(legLength^2 - distL);
--print("LS uLeft  / uRight",uLeft[1]-uTorsoActual[1],distL,uRight[1]-uTorsoActual[1],distR);

   else
     legHeight = math.sqrt(legLength^2 - distR);
--print("RS uLeft  / uRight",uLeft[1]-uTorsoActual[1],distL,	uRight[1]-uTorsoActual[1],distR);
