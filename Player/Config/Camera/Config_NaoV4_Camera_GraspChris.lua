...
camera.param[1] = {key='Contrast'       , val={60 , 20}};

camera.param[2] = {key='Saturation'     , val={190 , 170}};
...
camera.param[4] = {key='Exposure'       , val={45, 45}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'           , val={90 , 120}};
-- Sharpness should be set between 0 and 7
camera.param[6] = {key='Sharpness'      , val={5  , 3}};
