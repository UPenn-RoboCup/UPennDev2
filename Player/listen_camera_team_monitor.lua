...
Config.camera.auto_param = {};
Config.camera.auto_param[1] = {key='white balance temperature, auto', val={1}};
Config.camera.auto_param[2] = {key='power line frequency',   val={0}};
Config.camera.auto_param[3] = {key='backlight compensation', val={0}};
Config.camera.auto_param[4] = {key='exposure, auto',val={1}}; --1 for manual
Config.camera.auto_param[5] = {key="exposure, auto priority",val={0}};

Config.camera.param = {};
Config.camera.param[1] = {key='brightness',    val={0}};
Config.camera.param[2] = {key='contrast',      val={0}};
Config.camera.param[3] = {key='saturation',    val={8}};
Config.camera.param[4] = {key='gain',          val={0}};
Config.camera.param[5] = {key='white balance temperature', val={2800}};
Config.camera.param[6] = {key='sharpness',     val={255}};
Config.camera.param[7] = {key='exposure (absolute)',      val={800}};
...
function update_camera()
  ...
  if status.count == image_count then return; end
