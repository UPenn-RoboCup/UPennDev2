...
shared.desired.pLArm = vector.zeros(3); -- Just Arm pos
shared.desired.pRArm = vector.zeros(3);
shared.desired.dpLArm = vector.zeros(3); -- Change in Arm pos
shared.desired.dpRArm = vector.zeros(3);
