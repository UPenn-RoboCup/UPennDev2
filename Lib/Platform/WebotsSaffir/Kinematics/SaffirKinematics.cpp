...
std::vector<double>
saffir_kinematics_forward_joints(const double *r)  //dereks function to write
{
...
Transform
saffir_kinematics_forward_head(const double *q)
{
  Transform t;
...
Transform
saffir_kinematics_forward_l_arm(const double *q)
{
  Transform t;
...
Transform
saffir_kinematics_forward_r_arm(const double *q)
{
  Transform t;
  t = t.translateY(-shoulderOffsetY).translateZ(shoulderOffsetZ)
    .mDH(-PI/2, 0, q[0], 0)
...
std::vector<double>
saffir_kinematics_inverse_arm(Transform trArm, int arm)
{
...
std::vector<double>
saffir_kinematics_inverse_l_arm(Transform trArm)
{
  return saffir_kinematics_inverse_arm(trArm, ARM_LEFT);
}

std::vector<double>
saffir_kinematics_inverse_r_arm(Transform trArm)
{
  return saffir_kinematics_inverse_arm(trArm, ARM_RIGHT);
}

std::vector<double>
saffir_kinematics_inverse_leg(Transform trLeg, int leg)
{
...
std::vector<double>
saffir_kinematics_inverse_l_leg(Transform trLeg)
{
  return saffir_kinematics_inverse_leg(trLeg, LEG_LEFT);
}

std::vector<double>
saffir_kinematics_inverse_r_leg(Transform trLeg)
{
  return saffir_kinematics_inverse_leg(trLeg, LEG_RIGHT);
}
