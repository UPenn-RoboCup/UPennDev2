...
void httpd::input_cmd(in_cmd_type cmd, float value, char* res_str)
{
    ...
    case IN_CMD_WALK_MODE:
        if(value == 1)
        {
        	...
        	else
        	{
            	...
            	EnableListforDemo[24].uID = "Action";
            	EnableListforDemo[25].uID = "Action";
            	EnableListforDemo[26].uID = "Test";
            	EnableListforDemo[27].uID = "Test";

        		Action::GetInstance()->Start(31, EnableListforDemo);
        		while(Action::GetInstance()->IsRunning())
        			usleep(8000);
        		...
        		MotionStatus::m_EnableList[27].uID = "Test";
    ...
    case IN_CMD_PLAY_PAGE:
		...
		MotionStatus::m_EnableList[12].uID = "Walking";
		MotionStatus::m_EnableList[13].uID = "Walking";
    ...
    case IN_CMD_HEAD_PAN_ANGLE:
    	...
    	if(pindex == -1)
    	{
    		for(pindex = 0; pindex < MotionStatus::m_CurrentJoints.size(); pindex++)
    			if(MotionStatus::m_CurrentJoints[pindex].m_ID == 27)
    			{
    ...
    case IN_CMD_HEAD_TILT_ANGLE:
    	...
    	if(tindex == -1)
    	{
    		for(tindex = 0; tindex < MotionStatus::m_CurrentJoints.size(); tindex++)
    			if(MotionStatus::m_CurrentJoints[tindex].m_ID == 28)
    			{
