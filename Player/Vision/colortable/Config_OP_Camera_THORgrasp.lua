...
--[[ Params with Logitech C905 on DARwIn for THOR-OP Color Testing
camera.param = {};
camera.param[1] = {key='brightness',    val={120}};
camera.param[2] = {key='contrast',      val={133}};
camera.param[3] = {key='saturation',    val={143}};
camera.param[4] = {key='gain',          val={0}};
camera.param[5] = {key='white balance temperature', val={3439}};
camera.param[6] = {key='sharpness',     val={255}};
camera.param[7] = {key='exposure (absolute)',      val={560}};
--]]

--Params with Logitech C905 on DARwIn for THOR-OP Color Testing
camera.param = {};
camera.param[1] = {key='brightness',    val={135}};
camera.param[2] = {key='contrast',      val={46}};
camera.param[3] = {key='saturation',    val={222}};
camera.param[4] = {key='gain',          val={0}};
camera.param[5] = {key='white balance temperature', val={3318}};
camera.param[6] = {key='sharpness',     val={255}};
camera.param[7] = {key='exposure (absolute)',      val={92}};
...
--camera.lut_file = 'thorTestGrasp_MonFeb10_14_field.raw';
