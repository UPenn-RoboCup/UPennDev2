...
camera.param[3] = {key='hue',           val={0}};
camera.param[4] = {key='gamma',         val={100}};
camera.param[4] = {key='gain',          val={50}};
camera.param[5] = {key='white balance temperature', val={4000}};
camera.param[6] = {key='sharpness',     val={0}};
camera.param[7] = {key='exposure (absolute)',      val={80}};

camera.lut_file = 'xos_grasp.raw';
