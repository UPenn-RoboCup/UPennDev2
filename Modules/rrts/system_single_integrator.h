...
namespace SingleIntegrator {
    ...
    public:    
      ...
      Transform fkLeft7(
        const double *q, const double *qWaist, 
        double handOffsetXNew, double handOffsetYNew, double handOffsetZNew
      );
        
      Transform fkLeftElbow7(const double *q, const double *qWaist);
      double distState(double* a, double* b, double *dists);
