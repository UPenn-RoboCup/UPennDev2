...
--for larger foot
  ...
  step_queue={
      ...
      {{0,0,0},   2,  0.1, 2, 0.1,   {0.00,-0.00,0},  {0, 0, 0}}, --pre-rs
      {{step1,0,0},1,  1,   2.5, 1,  {0.00,0.00,0},  {0,sh1,sh2}},    --RS
      {{0,0,0},   2,  0.1, 3, 0.1,   {0,00,0,0},  {0, 0, 0}},

      {{step2,0,0} ,0, 1,   2.2,  1,  {-0.00,-0.00,0},  {sh2,sh1,0.0}},--LS
