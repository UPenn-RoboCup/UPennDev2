...
--float    int      int       float     {fl,fl}     float     {x,y,a}   {x,y,a}
--supportLeg0: Left // supportLeg1: Right
--supportLeg is the one that is NOT moving

walk.walkKickDef["FrontLeft"]={
  {0.20, 1, 0, 0.020 , {0,0}, 0.5, {0.03,0,0} },
  {0.25, 2, 1, 0.040 , {0.02,-0.01}, 0.3, {0.08,0,0}, {0.04,0,0} },
  {walk.tStep, 1, 0, 0.020 , {0,0}, 0.3, {0,0,0} },
}
walk.walkKickDef["FrontRight"]={
  {0.20, 1, 1, 0.020 , {0,0}, 0.5, {0.03,0,0} },
  {0.25, 2, 0, 0.040 , {0.02,0.02}, 0.7,  {0.08,0,0}, {0.04,0,0} },
  {walk.tStep, 1, 1, 0.020 , {0,0}, 0.7, {0,0,0} },
}

walk.walkKickDef["SideLeft"]={
  {0.20, 1, 1, 0.020 , {0,0}, 0.4, {0.04,0.00,0.0} },
  {0.25, 3, 0, 0.040 , {-0.02,0.02}, 0.5, {0.06,-0.03,0},{0.09,0.00,0}},
 {walk.tStep, 1, 1, 0.020 , {-0.03,0}, 0.5, {0,0,0} },}

walk.walkKickDef["SideRight"]={
  {0.20, 1, 0, 0.020 , {0,0}, 0.6, {0.04,-0.00,0} },
  {0.25, 3, 1, 0.040 , {-0.02,-0.02},0.5, {0.06,0.03,0},{0.09,-0.00,0}},
  {walk.tStep, 1, 0, 0.020 , {-0.03,0},0.5,  {0,0,0} },
}
...
zmpstep.motionDef["nonstop_kick_left"]={
  ...
  stepDef={
    ...
    {1, {0.06,0,0},{0.0,0.0},0.8}, --RS step, lifting
