...
local surfaces2D={ 
--[[
  {0,   0.40,     -0.5,0.5,     0.0,0}, 
  {0.40,0.68,  -0.5,0.5,  0.15,0},  
  {0.68,1.10,  -0.5,0.5,  0.0,0},    
--]]

  {0.46,0.86,  0.5,1.5,     0.0,0}, 
  {0.86,1.14,  0.5,1.5,  0.15,0},  
  {1.14,1.52,  0.5,1.5,  0.0,0},    

  {1.50, 1.86,  -0.4,0.4,     0.0,0}, 
  {1.86,2.14,  -0.4,0.4,  0.15,0},  
  {2.14,2.52,  -0.4,0.4,  0.0,0},    

  {2.46,2.86,  -1.5,-0.5,  0.0,0}, 
  {2.86,3.14,  -1.5,-0.5,  0.15,0},  
  {3.14,3.52,  -1.5,-0.5,  0.0,0},    



  {0.44, 0.70,  -0.30,0.30, 0.0,0}, 
  {0.70,1.20,  -0.30,0.30,  0.05,0},  
  {1.20,1.60,  -0.5,0.5,  0.0,0},    

--[[
  {1.44, 1.70,  0.25,1.25, 0.0,0}, 
  {1.70,2.20,  0.25,1.25,  0.05,0},  
  {2.20,2.70,  0.5,1.5,  0.0,0},    

  {2.44, 2.70,  -0.25,0.25, 0.0,0}, 
  {2.70,3.20,  -0.25,0.25,  0.05,0},  
  {3.20,3.70,  -0.5,0.5,  0.0,0},    
--]]


    {0.0,0.40,    -2.2,0.2,      0,   0}, 
    {0.40,1.00,   -2.2,0.2,     0.08,   -0.262}, 
    {1.00,1.60,   -2.2,0.2,     0.08,    0.262}, 
    {1.60,2.00,    -2.2,0.2,      0,   0}, 

}


--Single ramp at around 2.0m 
...
--[[
  local h0,p0 = find_current_surface_height(uFoot)
  local h1,p1 = find_current_surface_height(best_foot)
  best_zpr[1]=h1-h0
  --,best_zpr[2] = h1-h0,p1-p0
--]]
