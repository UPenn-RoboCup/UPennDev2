...
local FT14217 = {
  ...
  --[[
	...
	--]]
	matrix = {
		{2.240558709,	3.218986556,	-69.63029032,	-582.5076037,	26.58950702,	592.2642631},
		{10.19864992,	736.6781729,	-94.62276354,	-349.9217562,	165.6883843,	-334.6196962},
		{955.5783269,	120.5262766,	798.0196977,	40.30872771,	983.9666329,	40.46231492},
		{0.3482179819,	10.65672779,	-21.00813819,	-6.199051297,	21.90201602,	-3.792932745},
		{22.44021204,	2.904536952,	-11.9208663,	7.302663208,	-9.480898963,	-9.066890511},
		{-2.926029219,	-11.49809674,	2.524328393,	-9.949251456,	-0.4557885505,	-10.14491817},
	},
	gain = 1,
}
local FT16464 = {
...
Config.right_foot_ft = FT14216
Config.left_foot_ft  = FT14217
...
--	m_ids = {15,17,19, 21, 23,25, 27},
	m_ids = {15,17,19, 21, 23,25}, --now no waist pitch!
	enable_read = true,
}
...
--	251000,251000,251000,251000,251000,151875,151875, --RArm (mk2 arm)
	251000,251000,251000,251000,151875,151875,151875, --RArm (mk2 arm)  --jinwook
	251000,251000, -- Waist
...
--	0,0,0,  -45  ,0,0, --RLeg  , teddy2, after leg swap
	...
	0,0,0,  0  ,0,0, --LLeg , teddy2, after leg swap
	0,0,0,  0  ,0,0, --RLeg  , teddy2, after leg swap
...
--	90,  90,  90,-45,  90,0,-90, --RArm, teddy, wristYaw fix
	...
	0, 0, 0, -- right gripper/trigger (UCLA rev2 verified)
