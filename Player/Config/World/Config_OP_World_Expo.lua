...
world.Lcorner={};
--Field edge
world.Lcorner[1]={2.7,1.75};
world.Lcorner[2]={2.7,-1.75};
world.Lcorner[3]={-2.7,1.75};
world.Lcorner[4]={-2.7,-1.75};
--Center T edge
world.Lcorner[5]={0,1.75};
world.Lcorner[6]={0,-1.75};
--Penalty box edge
world.Lcorner[7]={-2.05,1.22};
world.Lcorner[8]={-2.05,-1.22};
world.Lcorner[9]={2.05,1.22};
world.Lcorner[10]={2.05,-1.22};
--Penalty box T edge
world.Lcorner[11]={2.7,1.22};
world.Lcorner[12]={2.7,-1.22};
world.Lcorner[13]={-2.7,1.22};
world.Lcorner[14]={-2.7,-1.22};
--Center circle junction
world.Lcorner[15]={0,0.6};
world.Lcorner[16]={0,-0.6};
...
--And sometimes they can be falsely detected as T edges
--Penalty box T edge #2 
world.Lcorner[17]={2.05,1.75};
world.Lcorner[18]={2.05,-1.75};
world.Lcorner[19]={-2.05,1.75};
world.Lcorner[20]={-2.05,-1.75};
