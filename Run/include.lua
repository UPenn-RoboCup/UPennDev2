...
package.path = _HOME_.."/Framework/Motion/States/Locomotion/?.lua;"..package.path
package.path = _HOME_.."/Framework/Motion/States/Manipulation/?.lua;"..package.path
package.path = _HOME_.."/Framework/Motion/States/Attention/?.lua;"..package.path
