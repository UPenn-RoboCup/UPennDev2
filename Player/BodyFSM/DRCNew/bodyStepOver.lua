...
--for larger foot
  step_queue={
      ...
      {{step1,0,0},0,  0.5, 2.2,   1,   {0,-0.02,0}, {0,sh1,sh2}},   --LS
      {{0,0,0},   2,  0.1, 1, 0.1,   {0,0.0,0},  {0, 0, 0}},

      {{step1,0,0},1,  1,   2.2, 1,    shift1,  {0,sh1,sh2}},    --RS

      {{0,0,0},   2,  0.1, 3, 0.1,   {0,0.0,0},  {0, 0, 0}},

      {{step2,0,0} ,0, 1,   2.2,  1,    shift2,  {sh2,sh1,0.0}},--LS
      {{0,0,0},   2,  0.1, 2, 0.1,      shift2,  {0, 0, 0}},
      {{step2,0,0}, 1,  1,  2.2, 1,   {0,0.0,0},  {sh2,sh1,0.0}},--RS
  ...
  step_queue={
      {{0,0,0},   2,  0.1, 1, 0.1,   {0,0.0,0},  {0, 0, 0}},
--[[
      {{step1,0,0},0,  0.5, 2.2,   1,   {-0.03,-0.04,0}, {0,sh1,sh2}},   --LS
      {{0,0,0},   2,  0.1, 1, 0.1,   {-0.030,0.0,0},  {0, 0, 0}},
      {{step1,0,0},1,  1,   2.2, 1,  {-0.010,0.020,0},  {0,sh1,sh2}},    --RS
      {{0,0,0},   2,  0.1, 3, 0.1,   {-0,010.0,0},  {0, 0, 0}},
--]]
      {{step1,0,0},0,  0.5, 2.5,   1,   {-0.03,-0.04,0}, {0,sh1,sh2}},   --LS
      {{0,0,0},   2,  0.1, 2, 0.1,   {-0.030,0.0,0},  {0, 0, 0}},
      {{0,0,0},   2,  0.1, 2, 0.1,   {-0.00,-0.040,0},  {0, 0, 0}}, --pre-rs
      {{step1,0,0},1,  1,   2.5, 1,  {0.010,0.020,0},  {0,sh1,sh2}},    --RS
      {{0,0,0},   2,  0.1, 3, 0.1,   {-0,010,0,0},  {0, 0, 0}},



      {{0,0,0},   2,  0.1, 10, 0.1,   {-0,010.0,0},  {0, 0, 0}},





      {{step2,0,0} ,0, 1,   2.2,  1,  {-0.030,-0.040,0},  {sh2,sh1,0.0}},--LS
      {{0,0,0},   2,  0.1, 2, 0.1,    {-0.010,0,0},  {0, 0, 0}},
      {{step2,0,0}, 1,  1,  2.2, 1,   {0,0.020,0},  {sh2,sh1,0.0}},--RS
