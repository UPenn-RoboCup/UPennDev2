...
static void emit_lua_array_loops_start(lcmgen_t *lcm, FILE *f, lcm_member_t *lm, const char *n, int flags)
{
    if (g_ptr_array_size(lm->dimensions) == 0)
        return;
...
static void emit_lua_array_loops_end(lcmgen_t *lcm, FILE *f, lcm_member_t *lm, const char *n, int flags)
{
    if (g_ptr_array_size(lm->dimensions) == 0)
        return;
...
static void emit_lua_encode_array(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
    ...
    for (unsigned int m = 0; m < g_ptr_array_size(ls->members); m++) {
        ...
        emit_lua_array_loops_start(lcm, f, lm, "p", FLAG_NONE);
        ...
        emit_lua_array_loops_end(lcm, f, lm, "p", FLAG_NONE);
        emit(0,"");
    }
    emit(1,   "}");
    emit(1, "return pos;");
...
static void emit_lua_decode_array(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
    ...
    for (unsigned int m = 0; m < g_ptr_array_size(ls->members); m++) {
        ...
        emit_lua_array_loops_start(lcm, f, lm, "p", lcm_is_constant_size_array(lm) ? FLAG_NONE : FLAG_EMIT_MALLOCS);
...
static void emit_lua_decode_array_cleanup(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
    ...
    for (unsigned int m = 0; m < g_ptr_array_size(ls->members); m++) {
        ...
        emit_lua_array_loops_end(lcm, f, lm, "p", lcm_is_constant_size_array(lm) ? FLAG_NONE : FLAG_EMIT_FREES);
        emit(0,"");
    }
    emit(1,   "}");
    emit(1, "return 0;");
...
static void emit_lua_decode_cleanup(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
static void emit_lua_encoded_array_size(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
static void emit_lua_encoded_size(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
static void emit_lua_clone_array(lcmgen_t *lcm, FILE *f, lcm_struct_t *lr)
{
    ...
    for (unsigned int m = 0; m < g_ptr_array_size(lr->members); m++) {
        ...
        emit_lua_array_loops_start(lcm, f, lm, "q", lcm_is_constant_size_array(lm) ? FLAG_NONE : FLAG_EMIT_MALLOCS);
...
static void emit_lua_copy(lcmgen_t *lcm, FILE *f, lcm_struct_t *lr)
{
    char *tn = lr->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
static void emit_lua_destroy(lcmgen_t *lcm, FILE *f, lcm_struct_t *lr)
{
    char *tn = lr->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
static void emit_lua_struct_get_hash(lcmgen_t *lcm, FILE *f, lcm_struct_t *ls)
{
    char *tn  = ls->structname->lctypename;
    char *tn_ = dots_to_underscores(tn);
...
//        emit_lua_struct_get_hash(lcmgen, f, lr);
//        emit_lua_encode_array(lcmgen, f, lr);
//        emit_lua_encode(lcmgen, f, lr);
//        emit_lua_encoded_array_size(lcmgen, f, lr);
//        emit_lua_encoded_size(lcmgen, f, lr);
//
//        emit_lua_decode_array(lcmgen, f, lr);
//        emit_lua_decode_array_cleanup(lcmgen, f, lr);
//        emit_lua_decode(lcmgen, f, lr);
//        emit_lua_decode_cleanup(lcmgen, f, lr);
//
//        emit_lua_clone_array(lcmgen, f, lr);
//        emit_lua_copy(lcmgen, f, lr);
//        emit_lua_destroy(lcmgen, f, lr);
//
