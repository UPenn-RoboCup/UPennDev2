...
void MakeBodyHeightLower(double body_height)
{
	...
	double l_stride_radian = 0.0;
	double l_dsp = g_dsp;
	double l_period = 1800;
	double l_se_time = 1800;
	double l_foot_height = g_foot_height;
	double l_foot_roll  = g_foot_roll;
	double l_foot_pitch = g_foot_pitch;
	double l_foot_yaw   = g_foot_yaw;
	...
	g_stp1.PositionData.stBodyPosition.z = l_body_height - 0.5*l_fb_stride_length*tan(l_foot_pitch);
	g_stp1.PositionData.stBodyPosition.roll = 0.0;      g_stp1.PositionData.stBodyPosition.pitch = 0.1047*1.0;      g_stp1.PositionData.stBodyPosition.yaw = 0.0;
	...
	g_stp2.PositionData.stBodyPosition.z = l_body_height - l_fb_stride_length*tan(l_foot_pitch);
	g_stp2.PositionData.stBodyPosition.roll = 0.0;    g_stp2.PositionData.stBodyPosition.pitch = 0.1047*2.0;      g_stp2.PositionData.stBodyPosition.yaw = 0.0;
	...
	g_stp3.PositionData.stBodyPosition.z = l_body_height - l_fb_stride_length*tan(l_foot_pitch);
	g_stp3.PositionData.stBodyPosition.roll = 0.0;      g_stp3.PositionData.stBodyPosition.pitch = 0.1047*2.0;      g_stp3.PositionData.stBodyPosition.yaw = 0.0;
...
{
	  g_stp0.PositionData.bMovingFoot = NFootMove;        g_stp0.PositionData.dFootHeight = 0.0;               g_stp0.PositionData.dZ_Swap_Amplitude = 0.0;
	  g_stp0.PositionData.dShoulderSwingGain = 0.00;      g_stp0.PositionData.dElbowSwingGain = 0.0;
	  g_stp0.PositionData.stRightFootPosition.x = 0.0;    g_stp0.PositionData.stRightFootPosition.y = -95.0;   g_stp0.PositionData.stRightFootPosition.z = 0.0;
	  g_stp0.PositionData.stRightFootPosition.roll = 0.0; g_stp0.PositionData.stRightFootPosition.pitch = 0.0; g_stp0.PositionData.stRightFootPosition.yaw = 0.0;
	  g_stp0.PositionData.stBodyPosition.z = 650.0;
	  g_stp0.PositionData.stBodyPosition.roll = 0.0;      g_stp0.PositionData.stBodyPosition.pitch = 0.0;      g_stp0.PositionData.stBodyPosition.yaw = 0.0;
	  g_stp0.PositionData.stLeftFootPosition.x = 0.0;     g_stp0.PositionData.stLeftFootPosition.y = 95.0;     g_stp0.PositionData.stLeftFootPosition.z = 0.0;
	  g_stp0.PositionData.stLeftFootPosition.roll = 0.0;  g_stp0.PositionData.stLeftFootPosition.pitch = 0.0;  g_stp0.PositionData.stLeftFootPosition.yaw = 0.0;

	  g_stp0.TimeData.bWalkingState = InWalking;
	  g_stp0.TimeData.dAbsStepTime = 3000.0;    		g_stp0.TimeData.dDSPratio = 0.2;
	  g_stp0.TimeData.sigmoid_ratio_x = 1.0;    		g_stp0.TimeData.sigmoid_ratio_y = 1.0;    		 g_stp0.TimeData.sigmoid_ratio_z = 1.0;
	  g_stp0.TimeData.sigmoid_ratio_roll = 1.0; 		g_stp0.TimeData.sigmoid_ratio_pitch = 1.0; 		g_stp0.TimeData.sigmoid_ratio_yaw = 1.0;
	  g_stp0.TimeData.sigmoid_distortion_x = 1.0;    	g_stp0.TimeData.sigmoid_distortion_y = 1.0;     g_stp0.TimeData.sigmoid_distortion_z = 1.0;
	  g_stp0.TimeData.sigmoid_distortion_roll = 1.0; 	g_stp0.TimeData.sigmoid_distortion_pitch = 1.0; g_stp0.TimeData.sigmoid_distortion_yaw = 1.0;
	  ...
	  g_stp1.PositionData.bMovingFoot = LFootMove;        	g_stp1.PositionData.dFootHeight = 170.0;               g_stp1.PositionData.dZ_Swap_Amplitude = 10.0;
	  g_stp1.PositionData.dShoulderSwingGain = 0.0;      	g_stp1.PositionData.dElbowSwingGain = 0.0;
	  ...
	  g_stp1.PositionData.stRightFootPosition.roll = 0.0; 	g_stp1.PositionData.stRightFootPosition.pitch = 0.0; g_stp1.PositionData.stRightFootPosition.yaw = 0.0;
	  g_stp1.PositionData.stBodyPosition.z = 650.0;
	  g_stp1.PositionData.stBodyPosition.roll = 0.0;      	g_stp1.PositionData.stBodyPosition.pitch = 0.2;      g_stp1.PositionData.stBodyPosition.yaw = 0.0;
	  g_stp1.PositionData.stLeftFootPosition.x = -320.0;    g_stp1.PositionData.stLeftFootPosition.y = 95.0;     g_stp1.PositionData.stLeftFootPosition.z = 310.0;
	  g_stp1.PositionData.stLeftFootPosition.roll = 0.0;  	g_stp1.PositionData.stLeftFootPosition.pitch = 0.0;  g_stp1.PositionData.stLeftFootPosition.yaw = 0.0;

	  g_stp1.TimeData.bWalkingState = InWalking;
	  g_stp1.TimeData.dAbsStepTime = 3850.0;    g_stp1.TimeData.dDSPratio = 0.2;
	  g_stp1.TimeData.sigmoid_ratio_x = 0.65;    g_stp1.TimeData.sigmoid_ratio_y = 1.0;     g_stp1.TimeData.sigmoid_ratio_z = 1.0;
	  g_stp1.TimeData.sigmoid_ratio_roll = 1.0; g_stp1.TimeData.sigmoid_ratio_pitch = 1.0; g_stp1.TimeData.sigmoid_ratio_yaw = 1.0;
	  g_stp1.TimeData.sigmoid_distortion_x = 1.0;    g_stp1.TimeData.sigmoid_distortion_y = 1.0;     g_stp1.TimeData.sigmoid_distortion_z = 1.0;
	  g_stp1.TimeData.sigmoid_distortion_roll = 1.0; g_stp1.TimeData.sigmoid_distortion_pitch = 1.0; g_stp1.TimeData.sigmoid_distortion_yaw = 1.0;


	  g_stp3.PositionData.bMovingFoot = RFootMove;        g_stp3.PositionData.dFootHeight = 180.0;               g_stp3.PositionData.dZ_Swap_Amplitude = 0.0;
	  g_stp3.PositionData.dShoulderSwingGain = 0.0;      g_stp3.PositionData.dElbowSwingGain = 0.0;
	  g_stp3.PositionData.stRightFootPosition.x = -320.0;  g_stp3.PositionData.stRightFootPosition.y = -95.0;   g_stp3.PositionData.stRightFootPosition.z = 310.0;
	  g_stp3.PositionData.stRightFootPosition.roll = 0.0; g_stp3.PositionData.stRightFootPosition.pitch = 0.0; g_stp3.PositionData.stRightFootPosition.yaw = 0.0;
	  g_stp3.PositionData.stBodyPosition.z = 700.0;
	  g_stp3.PositionData.stBodyPosition.roll = 0.0;      g_stp3.PositionData.stBodyPosition.pitch =   0.2;      g_stp3.PositionData.stBodyPosition.yaw = 0.0;
	  g_stp3.PositionData.stLeftFootPosition.x = -320;     g_stp3.PositionData.stLeftFootPosition.y = 95.0;   g_stp3.PositionData.stLeftFootPosition.z = 310;
	  g_stp3.PositionData.stLeftFootPosition.roll = 0.0;  g_stp3.PositionData.stLeftFootPosition.pitch = 0.0;  g_stp3.PositionData.stLeftFootPosition.yaw = 0.0;

	  g_stp3.TimeData.bWalkingState = InWalking;
	  g_stp3.TimeData.dAbsStepTime = 4700.0;    	g_stp3.TimeData.dDSPratio = 0.2;
	  g_stp3.TimeData.sigmoid_ratio_x = 0.65;    	g_stp3.TimeData.sigmoid_ratio_y = 1.0;     g_stp3.TimeData.sigmoid_ratio_z = 1.0;
	  g_stp3.TimeData.sigmoid_ratio_roll = 1.0; 	g_stp3.TimeData.sigmoid_ratio_pitch = 1.0; g_stp3.TimeData.sigmoid_ratio_yaw = 1.0;
	  g_stp3.TimeData.sigmoid_distortion_x = 1.0;   g_stp3.TimeData.sigmoid_distortion_y = 1.0;     g_stp3.TimeData.sigmoid_distortion_z = 1.0;
	  g_stp3.TimeData.sigmoid_distortion_roll = 1.0; g_stp3.TimeData.sigmoid_distortion_pitch = 1.0; g_stp3.TimeData.sigmoid_distortion_yaw = 1.0;

	  g_stp4.PositionData.bMovingFoot = NFootMove;        g_stp4.PositionData.dFootHeight = 0.0;               g_stp4.PositionData.dZ_Swap_Amplitude = 0.0;
	  g_stp4.PositionData.dShoulderSwingGain = 0.0;      g_stp4.PositionData.dElbowSwingGain = 0.0;
	  g_stp4.PositionData.stRightFootPosition.x = -320.0;  g_stp4.PositionData.stRightFootPosition.y = -95.0;   g_stp4.PositionData.stRightFootPosition.z = 310.0;
	  g_stp4.PositionData.stRightFootPosition.roll = 0.0; g_stp4.PositionData.stRightFootPosition.pitch = 0.0; g_stp4.PositionData.stRightFootPosition.yaw = 0.0;
	  g_stp4.PositionData.stBodyPosition.z = 700.0;
	  g_stp4.PositionData.stBodyPosition.roll = 0.0;      g_stp4.PositionData.stBodyPosition.pitch =  0.2;      g_stp4.PositionData.stBodyPosition.yaw = 0.0;
	  g_stp4.PositionData.stLeftFootPosition.x = -320;     g_stp4.PositionData.stLeftFootPosition.y = 95.0;   g_stp4.PositionData.stLeftFootPosition.z = 310;
	  g_stp4.PositionData.stLeftFootPosition.roll = 0.0;  g_stp4.PositionData.stLeftFootPosition.pitch = 0.0;  g_stp4.PositionData.stLeftFootPosition.yaw = 0.0;

	  g_stp4.TimeData.bWalkingState = InWalking;
	  g_stp4.TimeData.dAbsStepTime = 7700.0;    g_stp4.TimeData.dDSPratio = 0.2;
	  g_stp4.TimeData.sigmoid_ratio_x = 0.7;    g_stp4.TimeData.sigmoid_ratio_y = 1.0;     g_stp4.TimeData.sigmoid_ratio_z = 1.0;
	  g_stp4.TimeData.sigmoid_ratio_roll = 1.0; g_stp4.TimeData.sigmoid_ratio_pitch = 1.0; g_stp4.TimeData.sigmoid_ratio_yaw = 1.0;
	  g_stp4.TimeData.sigmoid_distortion_x = 1.0;    g_stp4.TimeData.sigmoid_distortion_y = 1.0;     g_stp4.TimeData.sigmoid_distortion_z = 1.0;
	  g_stp4.TimeData.sigmoid_distortion_roll = 1.0; g_stp4.TimeData.sigmoid_distortion_pitch = 1.0; g_stp4.TimeData.sigmoid_distortion_yaw = 1.0;

}

void LadderUpOneStep()
{
	  stp0.PositionData.bMovingFoot = NFootMove;        stp0.PositionData.dFootHeight = 0.0;               stp0.PositionData.dZ_Swap_Amplitude = 0.0;
	  stp0.PositionData.dShoulderSwingGain = 0.00;      stp0.PositionData.dElbowSwingGain = 0.0;
	  stp0.PositionData.stRightFootPosition.x = 0.0;    stp0.PositionData.stRightFootPosition.y = -105.0;   stp0.PositionData.stRightFootPosition.z = 0.0;
	  ...
	  stp0.PositionData.stLeftFootPosition.x = 0.0;     stp0.PositionData.stLeftFootPosition.y = 105.0;     stp0.PositionData.stLeftFootPosition.z = 0.0;
	  ...
	  stp1.PositionData.bMovingFoot = LFootMove;        stp1.PositionData.dFootHeight = 0.0;               stp1.PositionData.dZ_Swap_Amplitude = 10.0;
	  stp1.PositionData.dShoulderSwingGain = 0.0;      stp1.PositionData.dElbowSwingGain = 0.0;
	  stp1.PositionData.stRightFootPosition.x = 0.0;  stp1.PositionData.stRightFootPosition.y = -105.0;   stp1.PositionData.stRightFootPosition.z = 0.0;
	  ...
	  stp1.PositionData.stBodyPosition.z = 620.0;
	  ...
	  stp1.PositionData.stLeftFootPosition.x = 0.0;     stp1.PositionData.stLeftFootPosition.y = 105.0;     stp1.PositionData.stLeftFootPosition.z = 300.0;
	  ...
	  stp1.TimeData.dAbsStepTime = 4500.0;    stp1.TimeData.dDSPratio = 0.2;
	  ...
	  stp2.PositionData.bMovingFoot = LFootMove;        stp2.PositionData.dFootHeight = 100.0;               stp2.PositionData.dZ_Swap_Amplitude = 0.0;
	  stp2.PositionData.dShoulderSwingGain = 0.00;      stp2.PositionData.dElbowSwingGain = 0.0;
	  stp2.PositionData.stRightFootPosition.x = 0.0;  stp2.PositionData.stRightFootPosition.y = -105.0;   stp2.PositionData.stRightFootPosition.z = 0.0;
	  ...
	  stp2.PositionData.stBodyPosition.z = 620.0;
	  ...
	  stp2.PositionData.stLeftFootPosition.x = -200.0;     stp2.PositionData.stLeftFootPosition.y = 105.0;   stp2.PositionData.stLeftFootPosition.z = 300.0;
	  ...
	  stp2.TimeData.dAbsStepTime = 6000.0;    stp2.TimeData.dDSPratio = 0.2;
...
void SetTheMotionEnableList(void)
{
	for(unsigned int jointIndex = 0; jointIndex < 35; jointIndex++)
	{
		...
		else if(id == 1 || id ==2 || id == 7|| id ==8)
			MotionStatus::m_EnableList[id-1].uID = "RecursiveWalking";
		else
			MotionStatus::m_EnableList[id-1].uID = "Test";
	}
...
int main(int argc, char *argv[])
{
	...
	outValue[2] -= (double)dir_output[2] * 11.0 * 251000.0/180.0;
	outValue[8] -= (double)dir_output[8] * 11.0 * 251000.0/180.0;
	...
	RecursiveWalking::GetInstance()->HIP_PITCH_OFFSET = 11.0;//6.0
...
//	}
	...
	while(true)
	{
		...
		else if(c_temp == 'o' || c_temp == 'O')
		{
			...
			{
				if(Test::GetInstance()->m_RobotInfo[idx].m_ID == 3)
					Test::GetInstance()->m_RobotInfo[idx].m_Value -= 1000;
				else if(Test::GetInstance()->m_RobotInfo[idx].m_ID == 4)
				{
					Test::GetInstance()->m_RobotInfo[idx].m_Value += 1000;
					break;
				}
			...
			printf("ShoulderOffset %d\n", Test::GetInstance()->m_RobotInfo[idx-1].m_Value);
		}
		...
		else if(c_temp == 'f' || c_temp == 'F')
		{
			...
			unsigned int idx = 0;
			unsigned int id1_idx = 0;
			for(idx = 0; idx < 30; idx++)
			{
				if(Test::GetInstance()->m_RobotInfo[idx].m_ID == 1 || Test::GetInstance()->m_RobotInfo[idx].m_ID == 8 )
				{
					Test::GetInstance()->m_RobotInfo[idx].m_Value -= 1000;
					if(Test::GetInstance()->m_RobotInfo[idx].m_ID == 1)
						id1_idx = idx;
				}
				else if(Test::GetInstance()->m_RobotInfo[idx].m_ID == 2 || Test::GetInstance()->m_RobotInfo[idx].m_ID == 7)
				{
					Test::GetInstance()->m_RobotInfo[idx].m_Value += 1000;
				}
			}
			printf("ShoulderElbowPos %d\n", Test::GetInstance()->m_RobotInfo[id1_idx].m_Value);
		}
		...
		else if(c_temp == 'h' || c_temp == 'H')
		{
			...
			RecursiveWalking::GetInstance()->BALANCE_ENABLE = false;
//			g_body_height -= 30;
//			g_body_pitch -= 0.15;
			MakeBodyHeightLower(380.0);
...
//			g_y_zmp_convergence = 105.0;
//			printf("Step Up Ladder\n");
//
