...
typedef enum{
    ...
    /*for demo action*/
    IN_CMD_PLAY_PAGE,
    IN_CMD_WALK_X_AMPLITUDE,
    IN_CMD_WALK_A_AMPLITUDE,
    IN_CMD_WALK_GO,
    IN_CMD_HEAD_PAN_ANGLE,
    IN_CMD_HEAD_TILT_ANGLE,
...
static const struct {
  ...
  /*action*/
  {"play_page", IN_CMD_PLAY_PAGE},
  {"walk_set_x", IN_CMD_WALK_X_AMPLITUDE},
  {"walk_set_a", IN_CMD_WALK_A_AMPLITUDE},
  {"walk_start_go", IN_CMD_WALK_GO},
  {"head_pan_angle", IN_CMD_HEAD_PAN_ANGLE},
  {"head_tilt_angle", IN_CMD_HEAD_TILT_ANGLE},
};
