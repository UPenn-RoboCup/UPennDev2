...
//=======
		...
		else if(strcmp(cmd, "hellomotion")==0) {
			...
			fprintf(stderr, "Press Any Key to start Hello Motion Number\n");
			_getch();
			Action::GetInstance()->Start(60, MotionStatus::m_EnableList);
			while(true) {
				usleep(8000);
				if( Action::GetInstance()->IsRunning() == false)
					break;
			...
			fprintf(stderr, "Press Any Key to start Hi Motion Number\n");
			_getch();
			Action::GetInstance()->Start(62, MotionStatus::m_EnableList);
			while(true) {
				usleep(8000);
				if( Action::GetInstance()->IsRunning() == false)
					break;
		...
		else if(strcmp(cmd, "dadmotion")==0) {
			...
			fprintf(stderr, "Press Any Key to start Dad and Son Motion \n");
			_getch();
			Action::GetInstance()->Start(67, MotionStatus::m_EnableList);
			while(true) {
				usleep(8000);
				if( Action::GetInstance()->IsRunning() == false)
					break;
		...
		else if(strcmp(cmd, "heartmotion")==0) {
			...
			fprintf(stderr, "Press Any Key to start Heart Motion \n");
			_getch();
			Action::GetInstance()->Start(71, MotionStatus::m_EnableList);
			while(true) {
				usleep(8000);
				if( Action::GetInstance()->IsRunning() == false)
					break;
		...
		else if(strcmp(cmd, "clappingmotion")==0) {
			...
			fprintf(stderr, "Press Any Key to start Clapping Motion \n");
			_getch();
			Action::GetInstance()->Start(73, MotionStatus::m_EnableList);
			while(true) {
				usleep(8000);
				if( Action::GetInstance()->IsRunning() == false)
					break;
