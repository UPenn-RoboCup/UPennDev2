...
vision.ball={};
vision.ball.diameter = 0.185;
vision.ball.th_min_color = 24;
vision.ball.th_min_color2 = 24;
...
vision.goal.th_min_fill_extent=0.4;
vision.goal.height_min = -1.0;

vision.goal.th_aspect_ratio={2.5,30};
