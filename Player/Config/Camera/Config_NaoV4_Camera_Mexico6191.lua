...
camera.param[1] = {key='Contrast'       , val={45 , 20}};

camera.param[2] = {key='Saturation'     , val={200, 240}};
...
camera.param[4] = {key='Exposure'       , val={55 , 80}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'           , val={80 , 120}};
...
camera.lut_file = 'lut_Mexico6191.raw';
