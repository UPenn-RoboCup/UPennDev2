...
camera.param[3] = {key='saturation',    val={25}};
camera.param[4] = {key='gain',          val={255}};
camera.param[5] = {key='white balance temperature', val={4420}};
camera.param[6] = {key='sharpness',     val={0}};
camera.param[7] = {key='exposure (absolute)',      val={447}};

camera.lut_file = 'lut_PF2_aditya.raw';
