...
kickTargetFront=Config.fsm.bodyKick.kickTargetFront or {0.10,0.04};
...
kickTh={0.01,0.03,7.5*math.pi/180}; 
...
print(string.format("Alignment: %.2f %.2f",xErr,yErr));
  align.set_velocity({xErr,yErr,0});
