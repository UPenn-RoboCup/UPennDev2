...
--copied from darwin op

walk.walkKickDef["SideLeft"]={
  {0.30, 1, 1, 0.035 , {0,0}, 0.4, {0.0,0.04,10*math.pi/180} },
  {0.35, 3, 0, 0.050 , {0.01,0.01}, 0.5,  
		{0.06,-0.05,-20*math.pi/180},{0.09,0.025,0}},
  {0.35, 1, 1, 0.035 , {0.01,0}, 0.5, {0,0,0} },}

walk.walkKickDef["SideRight"]={
  {0.30, 1, 0, 0.035 , {0,0}, 0.6, {0.0,-0.04,-10*math.pi/180} },
  {0.35, 3, 1, 0.050 , {0.01,-0.01},0.5,   
		{0.06,0.05,20*math.pi/180},{0.09,-0.025,0}},
  {0.35, 1, 0, 0.035 , {0.01,0},0.5,  {0,0,0} },
}
