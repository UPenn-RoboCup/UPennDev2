...
local char_to_armtr = {
  ['i'] = vector.new({0.02, 0, 0,   0,0,0}),
  [','] = vector.new({-.02, 0, 0,   0,0,0}),
  ['j'] = vector.new({0, 0.02, 0,   0,0,0}),
  ['l'] = vector.new({0, -.02, 0,   0,0,0}),
  ['u'] = vector.new({0, 0, 0.02,    0,0,0}),
  ['m'] = vector.new({0,0, -.02,   0,0,0}),
...
local function process_character(key_code,key_char,key_char_lower)
  ...
  if armtr then
    local right_tr_target = hcm.get_hands_right_tr_target()
    local right_tr_target_new = vector.new(right_tr_target)+
        vector.new(armtr)
