...
//		result = DXL.ReadWord(7, 626, &value1, 0);
//		result = DXL.ReadWord(7, 628, &value2, 0);
//		result = DXL.ReadWord(7, 630, &value3, 0);
//		result = DXL.ReadWord(7, 632, &value4, 0);


//		result = DXL.ReadWord(19, 626, &value1, 0);
//		result = DXL.ReadWord(19, 628, &value2, 0);
//		result = DXL.ReadWord(19, 630, &value3, 0);
//		result = DXL.ReadWord(19, 632, &value4, 0);


//		result = DXL.ReadWord(20, 626, &value1, 0);
//		result = DXL.ReadWord(20, 628, &value2, 0);
//		result = DXL.ReadWord(20, 630, &value3, 0);
//		result = DXL.ReadWord(20, 632, &value4, 0);
...
//		result = DXL.ReadWord(11, 626, &value1, 0);
//		result = DXL.ReadWord(11, 628, &value2, 0);
//		result = DXL.ReadWord(11, 630, &value3, 0);
//		result = DXL.ReadWord(11, 632, &value4, 0);
//		result = DXL.ReadWord( 9, 626, &value5, 0);
//		result = DXL.ReadWord( 9, 628, &value6, 0);

//		result = DXL.ReadWord(12, 626, &value1, 0);
//		result = DXL.ReadWord(12, 628, &value2, 0);
//		result = DXL.ReadWord(12, 630, &value3, 0);
//		result = DXL.ReadWord(12, 632, &value4, 0);
//		result = DXL.ReadWord(10, 626, &value5, 0);
//		result = DXL.ReadWord(10, 628, &value6, 0);

//		result = DXL.ReadWord(23, 626, &value1, 0);
//		result = DXL.ReadWord(23, 628, &value2, 0);
//		result = DXL.ReadWord(23, 630, &value3, 0);
//		result = DXL.ReadWord(23, 632, &value4, 0);
//		result = DXL.ReadWord(21, 626, &value5, 0);
//		result = DXL.ReadWord(21, 628, &value6, 0);

		result = DXL.ReadWord(24, 626, &value1, 0);
		result = DXL.ReadWord(24, 628, &value2, 0);
		result = DXL.ReadWord(24, 630, &value3, 0);
		result = DXL.ReadWord(24, 632, &value4, 0);
		result = DXL.ReadWord(22, 626, &value5, 0);
		result = DXL.ReadWord(22, 628, &value6, 0);

		fprintf(stderr, "READ VALUE : %d   %d    %d    %d  %d  %d", value1, value2, value3, value4, value5, value6);
		fprintf(stderr, "\r");
	}
	fprintf(stderr, "\n");
}
...
void PosTest()
{
	...
	while(true)
	{
		...
		{
			result = DXL.ReadDWord(jointID*2+15, 611, &dwEncPos[jointID], 0);
			result = DXL.ReadWord(jointID*2+15, 897, &wPotPos[jointID], 0);

			fprintf(stderr, "ID %d : %d %d ", jointID*2+15, (int)dwEncPos[jointID], wPotPos[jointID]);
