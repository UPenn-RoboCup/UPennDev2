 ...
 * while drawin an ascii vumeter on stderr
 *
 * "$Id: vumeter.c,v 1.1.1.1 2003/12/08 12:20:33 jaromil Exp $"
 */

// arecord -f S16_LE -c1 -D hw:2,0 -t raw | ./vumeter > test.tmp
// arecord -f S16_LE -c2 -D hw:3,0 -t raw | ./vumeter > test.tmp
