...
camera.param[1] = {key='Contrast'       , val={30 , 20}};

camera.param[2] = {key='Saturation'     , val={140 , 170}};
...
camera.param[4] = {key='Exposure'       , val={40 , 60}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'           , val={225 , 255}};
