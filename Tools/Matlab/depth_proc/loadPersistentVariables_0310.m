...
IMCX = 258;% DEPTH_W/2;
IMCY = 202;% DEPTH_H/2;
fx =  364.457362485643273; % DEPTH_W/2/tan(70.6/2*pi/180);
fy =  364.542810626989194; % DEPTH_H/2/tan(60/2*pi/180);
Sx = IMCX/fx;
Sy = IMCY/fy;
...
% parameters 
param_normalComputation = [5 3]; % 1: (odd nember)^2+1 <- window sizw,  2: increment  
thre_sValue = 0.02; % The smaller it is, the flatter the plane fit is 
thre_clusterSize = 50; % number of clusters
thre_memberSize = 70; % number of connected members (in the image domain)
