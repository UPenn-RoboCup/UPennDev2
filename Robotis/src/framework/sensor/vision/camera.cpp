...
Camera* Camera::uniqueInstance = new Camera();
...
void Camera::ErrorExit(const char* s)
{
...
int Camera::Initialize(int deviceIndex)
{
    struct stat st;
    char devName[15] = {0, };
    ...
    v4l2SetControl(V4L2_CID_BRIGHTNESS, 128);
    v4l2SetControl(V4L2_CID_CONTRAST, 128);
    v4l2SetControl(V4L2_CID_SATURATION, 128);
    v4l2SetControl(V4L2_CID_GAIN, 0);
    v4l2SetControl(V4L2_CID_EXPOSURE, 255);
    ...
    v4l2SetControl(V4L2_CID_AUTO_WHITE_BALANCE, V4L2_EXPOSURE_AUTO);
    v4l2SetControl(V4L2_CID_AUTOGAIN, V4L2_EXPOSURE_AUTO);
    v4l2SetControl(V4L2_CID_HUE_AUTO, V4L2_EXPOSURE_AUTO);

    SetCameraSettings(settings);
    return 1;
}

void Camera::LoadINISettings(minIni* ini)
{
    int value = -2;
...
void Camera::SaveINISettings(minIni* ini)
{
...
void Camera::SetCameraSettings(const CameraSettings &newset)
{
