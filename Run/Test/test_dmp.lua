...
local minimum_jerk = interpol.minimum_jerk_trajectory(x0, g0, 0, tau, 150)
...
local nonlinearity = primitive:get_transformation_system(1):get_nonlinearity()
