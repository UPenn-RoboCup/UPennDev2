...
camera.param[2] = {key='Contrast',      val={41, 32}};
camera.param[3] = {key='Saturation',    val={245, 186}};
camera.param[4] = {key='Hue',           val={0, 0}};
camera.param[5] = {key='Exposure',      val={86, 78}};
camera.param[6] = {key='Gain',          val={41, 45}};
camera.param[7] = {key='Sharpness',  val={160, 160}};


camera.lut_file = 'lut_usopen.raw';
