...
camera.param = {};
camera.param[1] = {key='brightness',    val={179}};
camera.param[2] = {key='contrast',      val={10}};
camera.param[3] = {key='saturation',    val={30}};
camera.param[4] = {key='gain',          val={250}};
camera.param[5] = {key='white balance temperature', val={2000}};
camera.param[6] = {key='sharpness',     val={255}};
camera.param[7] = {key='exposure (absolute)',      val={1450}};

camera.lut_file = 'grasp_samarth_2200_pink.raw';
