...
kick.def["kickSideLeft"]={
  ...
  def = {
    {1, .6, {0,0,0}          }, --Stabilize
    {1, 0.6, {-0.01,-0.13,0}           }, --COM slide
    {2, 0.3, {-0.01,-0.17,0} , { 0,     0.12,  0}, 0.06 ,0*math.pi/180}, --Lifting
    {2, 0.3, {-0.01,-0.17,0} , { 0.18,     0,  0}, 0.06 ,0*math.pi/180}, --Lifting
    {4, 0.3, {-0.01,-0.17,0} , { 0,  -0.18,  -0},  0.06 , 0*math.pi/180}, --Kicking
    {2, 0.6, {-0.01,-0.13,0} , {-0.18,  0.06,0}, 0, 0 }, --Landing
    {1, .6, {0,0,0}          }, --Stabilize
...
kick.def["kickSideRight"]={
  ...
  def = {
    {1, .6, {0,0,0}          }, --Stabilize
    {1, 0.6, {-0.01,0.13,0}         }, --COM slide
    {3, 0.3, {-0.01,0.17,0} ,  {0, -0.12, -0}, 0.06 ,0*math.pi/180 }, --Lifting
    {3, 0.3, {-0.01,0.17,0} ,  {0.18, -0, -0}, 0.06 ,0*math.pi/180 }, --Lifting
    {5, 0.3, {-0.01,0.17,0} , {0,  0.18, 0},  0.06 , 0*math.pi/180}, --Kicking
    {3, 0.6, {-0.01,0.13,0} , {-0.18, -0.06,0}, 0, 0 }, --Landing
    {1, .6, {0,0,0}          }, --Stabilize
    {6, 0.6, {0.00, 0.00, 0}},--Stabilize
 },
}
