...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {2, 0.1, {-0.01, -0.055,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180}, --Lifting
     {4, 0.2, {-0.01,-0.055,0} , {0.30,0,0},  0.07 , 0*math.pi/180}, --Kicking
...
kick.def["kickForwardRight"]={
  ...
  def = {
    ...
    {3, 0.1, {-0.01 ,0.055,0} , {-0.06, 0.0, 0}, 0.10 , 40*math.pi/180}, 
    {5, 0.2, {-0.01 ,0.055,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180},--Kicking
