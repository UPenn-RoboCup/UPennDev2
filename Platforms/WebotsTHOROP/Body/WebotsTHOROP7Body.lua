...
jointNames = {"neck_yaw","head_pitch",
              "l_shoulder_pitch", "l_shoulder_roll", "l_shoulder_yaw","l_elbow_pitch","l_wrist_yaw","l_wrist_roll","l_wrist_yaw2",
              ...
              "r_shoulder_pitch", "r_shoulder_roll", "r_shoulder_yaw","r_elbow_pitch","r_wrist_yaw","r_wrist_roll","r_wrist_yaw2",
	      "chest_yaw",
...
indexLArm = 3;			--LArm: 3 4 5 6 7 8 9
nJointLArm = 7; 		

indexLLeg = 10;			--LLeg:10 11 12 13 14 15
nJointLLeg = 6;
indexRLeg = 16; 		--RLeg: 16 17 18 19 20 21
nJointRLeg = 6;

indexRArm = 22; 		--RArm: 22 23 24 25 26 27 28
nJointRArm = 7;
...
jointReverse={
	5,7,9,  --LArm:  3 4 5 6 7 8 9
        --LLeg: 10 11 12 13 14 15
        --RLeg: 16 17 18 19 20 21
        24,26,28,--RArm: 22 23 24 25 26 27 28
	 --Waist: 29
	--Left gripper: 30 31
	--Right gripper: 32 33
}
