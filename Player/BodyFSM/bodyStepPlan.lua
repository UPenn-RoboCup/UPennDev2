...
function calculate_footsteps()
  ...
  for i=1,10 do
    ...
    if i==1 then
      new_step={leg_movement, supportLeg, tSlope1, Config.walk.tStep-tSlope1-tSlope2, {0,0,0}}
    else
      new_step={leg_movement, supportLeg, tSlope1+tSlope2, Config.walk.tStep-tSlope1-tSlope2, {0,0,0}}
    end
    step_queue[step_queue_count]=new_step
  end
  step_queue[step_queue_count] = {{},2, 1,1,{0,0,0}}
end
