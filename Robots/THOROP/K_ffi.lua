...
-1*(c1*c2),
-1*(s1*s3 - s2*c1*c3),
-1*(-(s1*c3 + s2*s3*c1)*s4 + c1*c2*c4),
-1*(((s1*c3 + s2*s3*c1)*c4 + s4*c1*c2)*c5 - (s1*s3 - s2*c1*c3)*s5),
-1*((((s1*c3 + s2*s3*c1)*c4 + s4*c1*c2)*s5 + (s1*s3 - s2*c1*c3)*c5)*s6 + (-(s1*c3 + s2*s3*c1)*s4 + c1*c2*c4)*c6)
		},
		{
-1*(1),
-1*(0),
...
-1*(c2*c3),
-1*(s2*c4 + s3*s4*c2),
-1*((s2*s4 - s3*c2*c4)*c5 - s5*c2*c3),
-1*(((s2*s4 - s3*c2*c4)*s5 + c2*c3*c5)*s6 + (s2*c4 + s3*s4*c2)*c6)
		},
		{
-1*(0),
-1*(c1),
-1*(-s1*c2),
-1*(s1*s2*c3 + s3*c1),
-1*(-(-s1*s2*s3 + c1*c3)*s4 - s1*c2*c4),
-1*(((-s1*s2*s3 + c1*c3)*c4 - s1*s4*c2)*c5 - (s1*s2*c3 + s3*c1)*s5),
-1*((((-s1*s2*s3 + c1*c3)*c4 - s1*s4*c2)*s5 + (s1*s2*c3 + s3*c1)*c5)*s6 + (-(-s1*s2*s3 + c1*c3)*s4 - s1*c2*c4)*c6)
		}
	}
end
