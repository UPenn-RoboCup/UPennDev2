...
--		tr={0.37, 0.31, -0.05, -90*DEG_TO_RAD, 0*DEG_TO_RAD,0},
		tr={0.37, 0.31,-0.05, 0*DEG_TO_RAD, 0*DEG_TO_RAD, 0*DEG_TO_RAD},
		weights = {1,1,0}
	},
	right = false,
}
...
table.insert(arm.grasping, {
	...
	--	tr={0.4338 + (len - len*0.7071), -0.277838-len*0.707, -0.089592, -0.003704, -0.055883, 45*DEG_TO_RAD},
	--	tr={0.4338 - 0.03, -0.277838-0.13, -0.039592, -0.003704, -0.055883, 45*DEG_TO_RAD},   --45deg

	--    tr = {0.438,   -0.2752,   -0.0693,   -0.0,   -0.0,    0.0},

		tr={0.44, -0.277838, -0.039592, -0.003704, -0.055883, 0.000970}, --norminal

--		tr={0.44-dim*0.707, -0.277838 -dim*0.707, -0.039592, -0.003704, -0.055883, 45*DEG_TO_RAD},   --45deg
