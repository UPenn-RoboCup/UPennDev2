...
#ifndef WALKING130610_H_
#define WALKING130610_H_
...
#define WALKING130610_SECTION "Walking130610 Config"
#define INVALID_VALUE -1024.0


namespace Thor
{
	class Walking130610 : public MotionModule
	{
	public:
		enum
		{
	...
	private:
		static Walking130610* m_UniqueInstance;
		...
		double m_Euler_Init_Angle_X;
		double m_Euler_Init_Angle_Y;
	...
	public:
		...
		bool   FB_BALANCE_ENABLE;
		bool   RL_BALANCE_ENABLE;

		bool   FB_ALL_BALANCE_ENABLE;
		bool   RL_ALL_BALANCE_ENABLE;
		...
		double BALANCE_ANKLE_PITCH_EULER_ANGLE_GAIN;
		double BALANCE_ANKLE_ROLL_EULER_ANGLE_GAIN;
		...
		virtual ~Walking130610();

		static Walking130610* GetInstance() { return m_UniqueInstance; }

		void Initialize();
		void SetInitialEulerAngle();
		void Start();
		void Stop();
		void Process();
		bool IsRunning();
