...
camera.param = {};
camera.param[1] = {key='brightness',    val={255}};
camera.param[2] = {key='contrast',      val={3}};
camera.param[3] = {key='saturation',    val={38}};
camera.param[4] = {key='gain',          val={255}};
...
camera.lut_file='usopen_aditya_4_19_time_20_31.raw';
