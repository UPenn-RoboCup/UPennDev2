...
camera.auto_param[4] = {key='Horizontal Flip',   val={1, 0}};
--Top camera is flipped
camera.auto_param[5] = {key='Vertical Flip',   val={1, 0}};


camera.param = {};
camera.param[1] = {key='Brightness',    val={220, 220}};
camera.param[2] = {key='Contrast',      val={56, 56}};
camera.param[3] = {key='Saturation',    val={245, 245}};
camera.param[4] = {key='Hue',           val={0, 0}};
camera.param[5] = {key='Exposure',      val={98, 98}};
camera.param[6] = {key='Gain',          val={64, 64}};
camera.param[7] = {key='Sharpness',  val={160, 160}};


camera.lut_file = 'lut_usopen_high_contra.raw';
