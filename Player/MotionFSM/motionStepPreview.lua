...
--]]
  ...
  step_planner:step_enque_trapezoid({0.25,0,0},0,  0.5, 2, {0,0.0,0}) --LS  
  step_planner:step_enque_trapezoid({0.50,0,0},1,  1, 4, {0,0.0,0}) --RS  
  step_planner:step_enque_trapezoid({0.25,0,0},0,  1, 2, {0,0.0,0}) --LS  
...
function walk.update()
  ...
  while t_discrete<t do
    ...
    uLeft_now, uRight_now, uLeft_next, uRight_next,
      supportLeg, ph, ended = zmp_solver:get_current_step_info(t_discrete + time_discrete_shift)
