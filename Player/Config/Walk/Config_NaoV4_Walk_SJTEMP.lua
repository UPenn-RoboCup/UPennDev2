...
zmpstep.motionDef["nonstop_kick_left"]={
  ...
  stepDef={
    ...
    {0, {0.04,0,0},{0,0},0.26}, --LS step
    {2, {0,0,0},   {0,0},0.05}, --DS step

    {1, {0,-0.01,0}    ,{0.01,-0.02},0.2,1}, --RS step, lifting
    {1, {0.14,0,0}     ,{0.005,-0.02},0.3,2}, --RS step  kicking
    {1, {-0.04,0.01,0} ,{0.005,-0.02},0.1,3}, --RS step  returning
...
zmpstep.motionDef["nonstop_kick_right"]={
  ...
  stepDef={
    {2, {0,0,0},{0,0},0.10}, --DS step
    {1, {0.04,0.0,0},{0,0},0.26}, --RS step
    {2, {0,0,0},{0,0},0.05}, --DS step

--
    {0, {0,0.01,0}      ,{0.01,0.02},0.2,1}, --LS step, lifting
    {0, {0.14,0,0}      ,{0.005,0.02},0.3,2}, --LS step  kicking
    {0, {-0.04,-0.01,0} ,{0.005,0.02},0.1,3}, --LS step  returning
    {0, {0.0,0,0}       ,{0.01,0.0},0.2,4}, --LS step  landing
--

--[[
    {0, {-0.02,0.01,0}      ,{0.01,0.02},0.2,1}, --LS step, lifting
    {0, {0.19,0,0}      ,{-0.01,0.02},0.3,2}, --LS step  kicking
    {0, {-0.07,-0.01,0} ,{-0.01,0.02},0.1,3}, --LS step  returning
    {0, {0.0,0,0}       ,{0.01,0.0},0.2,4}, --LS step  landing
--]]
