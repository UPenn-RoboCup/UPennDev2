#ifndef WEBOTS_KINEMATICS_H_
#define WEBOTS_KINEMATICS_H_
...
Transform saffir_kinematics_forward_head(const double *q);
Transform saffir_kinematics_forward_l_arm(const double *q);
Transform saffir_kinematics_forward_r_arm(const double *q);
Transform saffir_kinematics_forward_l_leg(const double *q);
Transform saffir_kinematics_forward_r_leg(const double *q);
std::vector<double> saffir_kinematics_forward_joints(const double *r);

std::vector<double> saffir_kinematics_inverse_r_arm(const Transform trArm);
std::vector<double> saffir_kinematics_inverse_l_arm(const Transform trArm);
std::vector<double> saffir_kinematics_inverse_r_leg(const Transform trLeg);
std::vector<double> saffir_kinematics_inverse_l_leg(const Transform trLeg);
std::vector<double> saffir_kinematics_inverse_joints(const double *q);
