...
%{
  ...
  lms2 = uicontrol('Parent', H_FIGURE, 'Style', 'pushbutton', ...
	'String', 'Head LIDAR', 'Units', 'Normalized', ...
	'Position', [SECOND_COL+SECOND_COL_W-0.05 SECOND_ROW_CAM-0.26 0.05 0.04] );

  lms3 = uicontrol('Parent', H_FIGURE, 'Style', 'pushbutton', ...
	'String', 'Chest LIDAR', 'Units', 'Normalized', ...
	'Position', [SECOND_COL+SECOND_COL_W-0.05 SECOND_ROW_CAM-0.30 0.05 0.04] );
    %}
