...
function draw_stats()
  ...
  curses.move(x, y)
  curses.printw('velocity :%7.4f %7.4f %7.4f\n', unpack(walk:get_velocity()))
	curses.printw( "LIDAR Dim: %d, %d\n", Laser.get_width(), Laser.get_height())
  curses.move(get_cursor(row, col))
  curses.refresh()
end
...
function update()
  ...
  Motion.update()
	...
	local lidar_scan = Laser.get_scan()
