...
function update()
  ...
  if (role == 2) then
    -- defend
    homePosition = 1.4 * ballGlobal;
    homePosition[1] = homePosition[1] + 0.50*util.sign(attackGoalPosition[1]);
    homePosition[2] = homePosition[2] - 0.80*util.sign(attackGoalPosition[2]);
