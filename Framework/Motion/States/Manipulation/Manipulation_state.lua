...
function set_joint_goal_enabled(enabled)
	manipulation_controller_inputs.JointSpaceGoalEnabled = enabled
end

function set_joint_goal_type(is_position_else_velocity)
	manipulation_controller_inputs.JointSpaceGoalType = is_position_else_velocity
end

function set_task_goal_enabled(enabled)
	manipulation_controller_inputs.TaskSpaceGoalEnabled = enabled
end

function set_task_goal_type(is_right_position_else_velocity,  is_left_position_else_velocity)
...
function set_task_space_motion_locks(task_space_motion_locks)
...
function set_inequality_constraints(inequality_constraints)
...
function set_obstacle_shell_position(obstacle_shell_position)
...
local function set_boolean_T_array_from_table(boolean_T_array, array_offset, boolean_array)
...
local function boolean_T_array_to_table(boolean_T_array, array_first, array_last)
	v = {}
	for index=array_first, array_last
		do 
